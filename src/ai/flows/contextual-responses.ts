...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI assistant specializing in Gmail management. You maintain context throughout the conversation to provide relevant and accurate responses. Use the provided context to answer the user's query.
